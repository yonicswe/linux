...
DECLARE_UVERBS_ATTR_SPEC(mlx5_spec_alloc_pd,
	UVERBS_ATTR_PTR_OUT(UVERBS_UHW_OUT, struct mlx5_ib_alloc_pd_resp,
			    UA_FLAGS(UVERBS_ATTR_SPEC_F_MANDATORY)));

DECLARE_UVERBS_ATTR_SPEC(mlx5_spec_device_query,
	UVERBS_ATTR_PTR_OUT_SZ(UVERBS_UHW_OUT, 0,
			       UA_FLAGS(UVERBS_ATTR_SPEC_F_MIN_SZ)));
/* TODO: fix sizes */
DECLARE_UVERBS_ATTR_SPEC(mlx5_spec_alloc_context,
